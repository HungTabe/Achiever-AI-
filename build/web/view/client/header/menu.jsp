      ...
      <div class="navbar navbar-default" role="navigation">
        ...
        <div class="navbar-collapse collapse">
          ...
          <ul class="nav navbar-nav">
            ...
            <li><a href="${pageContext.request.contextPath}/view/client/product">NẾN THƠM</a>
              <ul class="dropdown-menu">                
                <li>
                  <a href="product.jsp">
                    <img src="https://images.pexels.com/photos/225073/pexels-photo-225073.jpeg" width="30" height="20" style="margin-right:5px;">
                    Nến Thơm Chiều Hoàng Hôn
                  </a>
                </li>
                <li>
                  <a href="product.jsp">
            ...
            <li class="aa-search"><!-- search box -->
              <a class="aa-search-box">
                <form action="${pageContext.request.contextPath}/view/client/product/search" method="GET">
                  <input type="text" name="s" id="" placeholder="Tìm kiếm nến thơm..">
